...
<!--===============================================================================================-->
	<link rel="icon" type="image/png" href="{{ asset('admin/login/images/icons/favicon.icon') }}"/>
<!--===============================================================================================-->
		...
		<div class="container-login100" style="background-image: url('admin/login/images/bg-01.jpg');">
			...
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" action="/postlogin" method="POST">
                       ...
                       <div class="form-grup">
                         <label>NiP</label>
						<input class="input100" type="text" name="nim" placeholder="nim" onkeypress="return hanyaAngka(event)">
					</div>
